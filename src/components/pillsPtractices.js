                  ...
                  <MDBTabPane tabId="1">
                    <p>
                      ...
                      <ul className="mt-3">
                        ...
                        <li>
                          Par <strong className="red-text">internet</strong> ,
                          voir la page RESERVATION{" "}
                        </li>
                      </ul>
                    </p>
                    <p className=" my-3">
                      ...
                      <strong>
                        sauf les terres battues indisponibles du début de la
                        période de gel jusqu'à leur réfection au printemps
                      </strong>
                      .
                    </p>
                    <p className="my-3">
                    ...
                    <p className="my-3">
                      ...
                      trouvent un et nous sommes en train de constituer un
                      classeur des membres du Club consultable librement par
                      tous{" "}
                    ...
                    <MDBRow>
                      <MDBCol>
                        ...
                        <ul className="">
                          <li className="my-2">
                            Equipe Fanion{" "}
                            <strong className="light-blue-text">Hommes</strong>{" "}
                            en <strong className="red-text">Nationale 4</strong>
                            .
                          </li>
                          <li className="my-2">
                            Equipe Fanion{" "}
                            <strong className="light-blue-text">Dames</strong>{" "}
                            en <strong className="red-text">DSR</strong>.
                          </li>
                          <li className="my-2">
                            3 équipes{" "}
                            <strong className="light-blue-text">
                            ...
                            et 5 équipes{" "}
                            <strong className="red-text">Masculines</strong> en{" "}
                            <strong>Interclubs de Printemps </strong>.
                          </li>
                          <li className="my-2">
                            Équipes Masculines{" "}
                            <strong className="light-blue-text">3ème </strong>{" "}
                            et <strong className="red-text">4ème</strong> Série
                            en <strong>Championnat de Gironde</strong> .
                          </li>
                          <li className="my-2">
                            Équipes{" "}
                            <strong className="light-blue-text">
                          ...
                          <li className="my-2">
                            Équipes{" "}
                            <strong className="red-text">4ème série </strong>{" "}
                          ...
                          <MDBMedia tag="li">
                            ...
                            <MDBMedia body>
                              ...
                              <span className="">
                                ...
                                coordonner les activités des clubs.
                              </span>
                            </MDBMedia>
                          </MDBMedia>
                          <MDBMedia tag="li">
