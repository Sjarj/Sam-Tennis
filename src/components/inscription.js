    ...
    <section id="inscription" className="section">
      ...
      <MDBAnimation reveal type="fadeIn" delay="0.2s">
        <p className="text-center w-responsive mx-auto  my-5 lead">
          ...
          <strong>Club </strong>
          <strong>House</strong> et correspondent sauf pour les inscriptions
          Vacances et celles en cours de saison à une adhésion pour la saison
          sportive de début Octobre à fin Septembre. Cette adhésion permet la
          pratique du Tennis dans notre Club toute l'année.
        </p>
      </MDBAnimation>
        ...
        <MDBRow>
          <MDBCol md="6">
            <MDBAnimation reveal type="fadeIn" delay="0.4s">
              <h5 className="h5-responsive text-justify text-center indigo-text my-5">
                {" "}
              ...
              <ul className="tarifs">
                <li className="my-4">
                  ...
                  <strong>1er juin</strong> <strong>2019</strong> pour la saison
          ...
          <p className="text-center w-responsive mx-auto wow fadeIn my-5">
            ...
            coupons sport ou des chèques vacances. Ils peuvent être fractionnés
            et, par ailleurs les aides éventuelles, des collectivités locales,
            des comités d'établissement, sont prises en compte. Ils
            correspondent à nos tarifs pour la saison, mais ces derniers ne
            peuvent couvrir tous les cas de figure. Aussi des dérogations sont
            possibles pour les cas de figure non couverts.
          </p>
        </MDBRow>
      </MDBContainer>
    </section>
