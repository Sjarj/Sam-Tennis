              ...
              <div className="row mb-3">
                ...
                <div className="col-md-11 col-10">
                  ...
                  <ul style={{ listStyle: `none` }} className="pl-0 tarifs">
                    <li>
                      De Avril à Septembre. 14h à 20h du Lundi au Samedi, de 14h
                      à 19h le Dimanche.
                    </li>
                    <li>
              ...
              <div className="row">
                ...
                <div className="col-md-11 col-10">
                  ...
                  <ul style={{ listStyle: `none` }} className="pl-0 tarifs">
                    ...
                    <li>
                      Son Identifiant composé de : son NOM puis son(ses) PRENOMS
                      (en laissant un espace entre le NOM et les PRENOMS et
                      entre les PRENOMS)
                    </li>
