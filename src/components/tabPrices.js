              ...
              <MDBRow>
                <MDBCol md="12">
                  ...
                  <p className="text-center w-responsive mx-auto wow fadeIn my-5 lead">
                    <strong className="red-text">RÉDUCTION </strong> pour
                    enfants d'une même famille{" "}
                    <trong className="light-blue-text">
                      Ecole de Tennis - Cours Collectifs Jeunes
                    </trong>{" "}
                    : 2ème enfant - 10% sur sa cotisation, à partir du 3ème -
                    20% sur leur cotisation.
                  </p>
                  ...
                  <MDBTabContent activeItem={this.state.items["default"]}>
                    <MDBTabPane tabId="1">
                      <p className="mt-3">
                        Adultes{" "}
                        <strong className="light-blue-text">196 €</strong>
                      </p>
                      <p>
                        Couples
                      ...
                      <p>
                        ...
                        Adulte{" "}
                        <strong className="light-blue-text">96 € </strong> ,
                        Couple <strong className="red-text"> 142 €</strong>
                      </p>
                      <p>
                        Jeunes{" "}
                        <strong className="light-blue-text">117 €</strong>{" "}
                      </p>{" "}
                      <p>
                      ...
                      <MDBRow>
                        <MDBCol size="6" className="my-4">
                          <p className="mt-3">
                            ...
                            />
                            1 heure par semaine{" "}
                            <strong className="light-blue-text">158 €</strong>{" "}
                        ...
                        <p>
                          <strong className="red-text">
                            De 2008 à 2015 inclus, 30 séances, Licence et
                            Cotisation Jeune incluses{" "}
                          </strong>
                          . Mercredi matin, Mercredi après-midi, Samedi
                          après-midi sur les courts couverts de la Roseraie.
                        </p>
                      </MDBRow>
                    </MDBTabPane>
                    <MDBTabPane tabId="3">
                      <MDBRow>
                        ...
                        <MDBCol xs="1" sm="4" className="my-4">
                          <p>
                            <strong className="red-text">
                              Samedi matin sur les courts couverts de la
                              Roseraie
                            </strong>{" "}
                            <hr
                              style={{ maxWidth: "18rem" }}
                        ...
                        <MDBCol xs="1" sm="4" className="my-4">
                          <p>
                            <strong className="red-text">
                              Lundis, Mardis, Jeudis et Vendredis soirs à partir
                              de 18h sur les courts du Stade Robert Brettes
                            </strong>
                            <hr
                              style={{ maxWidth: "18rem" }}
                              className="my-3"
                        ...
                        <MDBCol size="12">
                          <p className="text-center">
                            ...
                            , <strong className="light-blue-text">30</strong>{" "}
                            séances d'une heure Licence et Cotisation incluses.
                          </p>
                        </MDBCol>
                      </MDBRow>
                    </MDBTabPane>
                    <MDBTabPane tabId="4">
                      ...
                      <p>
                        <strong>Adulte</strong> pour une heure. <br /> A la
                        Roseraie
                      ...
                      <hr />
                      <strong className="red-text">CARTE PARENTALE </strong>
                      Licence Non incluse
                      <p>
                        Permettant à 1 parent de jouer avec 1 de ses enfants
                        adhérent
