            ...
            <MDBTabPane tabId="1">
              <blockquote className="blockquote">
                ...
                <p className="blockquote-footer mb-1">
                  ...
                  un et nous sommes en train de constituer un classeur des
                  membres du Club consultable librement par tous{" "}
              ...
              <MDBRow>
                <MDBCol>
                  ...
                  <ul className="">
                    ...
                    <li className="my-2">
                      Equipe Fanion{" "}
                      <span className="light-blue-text">Dames</span> en{" "}
                      <span className="red-text">DSR</span>.
                    </li>
                    <li className="my-2">
                      3 équipes{" "}
                      <span className="light-blue-text">Féminines</span> et 5
                      équipes <span className="red-text">Masculines</span> en{" "}
                    ...
                    <li className="my-2">
                      ...
                      garçons et filles dans toutes les catégories d'âges de
                      9/10 11/12 13/14 et 15/16 ans, dans les différentes
                      compétitions{" "}
                  ...
                  <MDBMedia list className="mt-3 ">
                    <MDBMedia tag="li" className="my-3">
                      ...
                      <MDBMedia body>
                        ...
                        <span className="">
                          ...
                          beach tennis, du paratennis et des équipes de France
                          sur le site de la Fédération française de Tennis.
                        </span>
                      </MDBMedia>
                    </MDBMedia>
                    <MDBMedia tag="li">
                    ...
                    <MDBMedia tag="li">
                      ...
                      <MDBMedia body>
                        ...
                        <span className="">
                          Retrouvez toutes les informations sur l'organisation
                          du Tennis en Gironde.
                        </span>
                      </MDBMedia>
                    </MDBMedia>
                  </MDBMedia>
            ...
            <MDBTabPane tabId="3">
              ...
              <div className="row wow fadeIn" data-wow-delay="0.4s">
                  ...
                  <div className="card pricing-card">
                    ...
                    <div className="card-body streakd">
                      <ul className="list-unstyled">
                        ...
                        <li>
                          <p>
                            <strong>A LA ROSERAIE </strong>:<br /> Samedi de 9h
                            à 12h.
                          </p>
                        </li>
                        <li>
                ...
                <p>
                  ...
                  les <span className="red-text">Cours Collectifs</span> ont
                  lieu de début Octobre à fin Juin [hors les vacances
                  scolaires]. Il en est de même pour la 2ème heure. Les enfants
                  sont par groupe de niveau et d'âge similaires. Il y a un
                  enseignant par groupe et par terrain. Les groupes sont limités
                  à 8 enfants pour l'Ecole de Tennis et à 6 enfants pour les
                  Cours Collectifs Jeunes.
                </p>
              </div>
            </MDBTabPane>
